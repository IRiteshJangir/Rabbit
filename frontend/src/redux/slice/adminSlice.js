...
const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/admin/users/${id}`,{name,email,role},
    ...
    // backend sends { message, updateUser }
    return response.data.updateUser || response.data.user
        ...
        extraReducers: (builder) => { 
            builder
                ...
                .addCase(updateUser.fulfilled, (state, action) => {
                    ...
                    const userIndex = state.users.findIndex((user) => user && user._id === updateUser._id)
