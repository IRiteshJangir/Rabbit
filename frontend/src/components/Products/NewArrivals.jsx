    ...
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Discover the styles off the runways,freshly added to keep your
      ...
      <div
        ...
        className={`container mx-auto overflow-x-scroll space-x-6 flex relative ${isDragging ? "cursor-grabbing" : "cursor-grab"}`}
      >
