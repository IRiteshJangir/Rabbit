...
const ProductDetails = ({ productId }) => {
  ...
  const { selectedProduct, loading, error, similiarProducts } = useSelector(
  ...
  // console.log("The ID React is trying to fetch is:", productFetchId);
  useEffect(() => {
    if (productFetchId) {
      // console.log("Dispatching fetchProductDetails for:", productFetchId);
      dispatch(fetchProductDetails(productFetchId));
      // console.log("Dispatching fetchSimiliarProducts for:", productFetchId);
      dispatch(fetchSimiliarProducts(productFetchId));
    }
